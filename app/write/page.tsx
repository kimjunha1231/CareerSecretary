...
export default function WritePage() {
    return (
        <div className="w-full p-6 h-[calc(100vh-64px)]">
            <div className="grid grid-cols-12 gap-6 h-full">
                {/* Left Side: Resume Form (75%) */}
                <div className="col-span-9 h-full overflow-y-auto pr-4 custom-scrollbar">
                    <div className="mb-8">
                ...
                <div className="col-span-3 h-full border-l border-white/10 pl-4">
                    <ReferenceSidebar />
                </div>
            </div>
        </div>
